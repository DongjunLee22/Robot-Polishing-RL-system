...
public:
	...
	void SetRanges_pos(double dLower, double dUpper);
	...
	void AppendPoints(float dNewPoint[], bool bInvalidate = true, bool bAdd2List = true, bool bUseTrendRatio = true);
	...
	void SetYGridSpacing(double spacing);  // Y축 그리드 간격 설정 함수
...
protected:
	...
	double m_YGridSpacing;  // Y축 그리드 간격 변수
};
